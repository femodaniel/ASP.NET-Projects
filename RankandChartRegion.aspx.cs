    ...
    protected void Page_Load(object sender, EventArgs e)
   {
...

    {
        ...
        while (sqlreaderi.Read())
        {
            ...
            series.Points.AddXY(sqlreaderi["REGION"].ToString(), sqlreaderi["CARDED_COUNT"].ToString());
            series2.Points.AddXY(sqlreaderi["REGION"].ToString(), sqlreaderi["CARDABLE_COUNT"].ToString());
            series3.Points.AddXY(sqlreaderi["REGION"].ToString(), sqlreaderi["UNCARDED_COUNT"].ToString());
