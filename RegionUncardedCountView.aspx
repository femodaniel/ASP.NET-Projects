<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegionUncardedCountView.aspx.cs" Inherits="Default2" %>
...
<head runat="server">
    <title>Region View: UnCarded Count</title>
...
<div class= "col-md-12">
 ...
 <% string connStri = ConfigurationManager.ConnectionStrings["ConnStrSql"].ConnectionString;
    ...
    CMD1i.CommandText = string.Format("SELECT BRANCH_TABLE.REGION,COUNT(UAP_UNCARDED.FORACID) AS UNCARDED_COUNT FROM BRANCH_TABLE JOIN UAP_UNCARDED ON BRANCH_TABLE.SOL_ID =UAP_UNCARDED.SOL_ID GROUP BY BRANCH_TABLE.REGION ORDER BY  COUNT(UAP_UNCARDED.FORACID) DESC");
...
<div class="table-responsive">   
    <table id="example" class="table table-bordered table-hover table-striped" style="font-size:10px">
        <caption style="background-color:gold;"><h6 style="font-family: Corbel; color: #FFFFFF; font-weight: bold">REGION VIEW: UNCARDED ACCOUNTS</h6></caption> 
        <thead>
            <tr>
                <th>REGION</th>
