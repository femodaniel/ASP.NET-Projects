<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RankandChartZone.aspx.cs" Inherits="Default2" %>
...
<asp:chart ID="Chart1" runat="server" Width="820px" Height="279px">
 <Titles><asp:Title Text = "Zonal Carded Performance"></asp:Title></Titles>
<Series>
...
<asp:chart ID="Chart2" runat="server" Width="820px" Height="279px">
 <Titles><asp:Title Text = "Zonal Cardable Count"></asp:Title></Titles>
<Series>
...
<asp:chart ID="Chart3" runat="server" Width="820px" Height="279px">
 <Titles><asp:Title Text = "Zonal Uncarded Count"></asp:Title></Titles>
<Series>
