<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZonalCardedCountView.aspx.cs" Inherits="Default6" %>
...
<head runat="server">
<title>CARDED ACCOUNTS BY ZONES</title>
<meta charset="utf-8"/>
  ...
  <div class="row">
        ...
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default"> <%--Each Accordion starts here--%>            
               <div class="panel-heading" style="background-color:#551675; color:white">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="Dashboard2.aspx" style="font-size:12px;"><span class="glyphicon glyphicon-home">
                            </span> DashBoard</a>
                        </h4>
                    </div>                  
                </div>
...
<% string connStri = ConfigurationManager.ConnectionStrings["ConnStrSql"].ConnectionString;
    ...
    CMD1i.CommandText = string.Format("SELECT BRANCH_TABLE.ZONE,COUNT(UAP_CARDED.ACCOUNT_ID) AS CARDCOUNT FROM BRANCH_TABLE JOIN UAP_CARDED ON BRANCH_TABLE.SOL_ID =UAP_CARDED.BRANCH_CODE GROUP BY BRANCH_TABLE.ZONE ORDER BY  COUNT(UAP_CARDED.ACCOUNT_ID) DESC");
...
<div class="table-responsive">   
    <table id="example" class="table table-bordered table-hover table-striped" style="font-size:10px">
        <caption style="background-color:gold;"><h6 style="font-family: Corbel; color: #FFFFFF; font-weight: bold">ZONE VIEW: CARDED ACCOUNTS</h6></caption> 
        <thead>
            <tr>
                <th>ZONE</th>
        ...
        <tbody>
               <%
                   ...
                   while (sqlreaderi.Read())
                   {
                       ...
                       a3 = Convert.ToDouble(sqlreaderi.GetValue(sqlreaderi.GetOrdinal("CARDCOUNT")).ToString());                      
