<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchUncardedCountView.aspx.cs" Inherits="Default4" %>
...
<head runat="server">
 <title>UNCARDED ACCOUNTS BY BRANCH</title>
...
<% string connStri = ConfigurationManager.ConnectionStrings["ConnStrSql"].ConnectionString;
    ...
    CMD1i.CommandText = string.Format("SELECT BRANCH_TABLE.BRANCH,COUNT(UAP_UNCARDED.FORACID) AS UNCARDED_COUNT FROM BRANCH_TABLE JOIN UAP_UNCARDED ON BRANCH_TABLE.SOL_ID =UAP_UNCARDED.SOL_ID GROUP BY BRANCH_TABLE.BRANCH ORDER BY  COUNT(UAP_UNCARDED.FORACID) DESC");
...
<div class="table-responsive">   
    <table id="example" class="table table-bordered table-hover table-striped" style="font-size:10px">
        <caption style="background-color:gold;"><h6 style="font-family: Corbel; color: #FFFFFF; font-weight: bold">BRANCH VIEW: UNCARDED ACCOUNTS COUNT</h6></caption> 
        <thead>
            <tr>
                <th>BRANCH</th>
