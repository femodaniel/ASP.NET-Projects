<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegionUncardedSCView.aspx.cs" Inherits="Default8" %>
...
<head runat="server">
    <title>UNCARDED ACCOUNTS BY REGION</title>
<meta charset="utf-8"/>
  ...
  <div class="row">
        ...
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default"> <%--Each Accordion starts here--%>            
               <div class="panel-heading" style="background-color:#551675; color:white">
                        <h4 class="panel-title">
                            <a data-parent="#accordion" href="Dashboard2.aspx" style="font-size:12px;"><span class="glyphicon glyphicon-th">
                            </span> DashBoard</a>
                        </h4>
                    </div>                  
                </div>
...
<% string connStri = ConfigurationManager.ConnectionStrings["ConnStrSql"].ConnectionString;
    ...
    CMD1i.CommandText = string.Format("SELECT BRANCH_TABLE.REGION ,BRANCH_TABLE.ZONE,BRANCH_TABLE.BRANCH,UAP_UNCARDED.SCHM_CODE,COUNT(UAP_UNCARDED.FORACID) AS UNCARDED_COUNT FROM BRANCH_TABLE JOIN UAP_UNCARDED ON BRANCH_TABLE.SOL_ID =UAP_UNCARDED.SOL_ID GROUP BY BRANCH_TABLE.SOL_ID,BRANCH_TABLE.REGION,BRANCH_TABLE.ZONE,BRANCH_TABLE.BRANCH,UAP_UNCARDED.SCHM_CODE ORDER BY  COUNT(UAP_UNCARDED.FORACID) DESC");
...
<div class="table-responsive">   
    <table id="example" class="table table-bordered table-hover table-striped" style="font-size:10px">
        <caption style="background-color:gold;"><h6 style="font-family: Corbel; color: #FFFFFF; font-weight: bold">REGION VIEW:UNCARDED ACCOUNTS BY SCHEME CODE</h6></caption> 
        <thead>
            <tr>
                <th>REGION</th>
                <th>ZONE</th>
