<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RankandChartBranch.aspx.cs" Inherits="RankandChartBranch" %>
...
<asp:chart ID="Chart1" runat="server" Width="820px" Height="279px">
 <Titles><asp:Title Text = "Branch Carded Performance"></asp:Title></Titles>
<Series>
...
<asp:chart ID="Chart2" runat="server" Width="820px" Height="279px">
 <Titles><asp:Title Text = "Branch Cardable Count"></asp:Title></Titles>
<Series>
...
<asp:chart ID="Chart3" runat="server" Width="820px" Height="279px">
 <Titles><asp:Title Text = "Branch Uncarded Count"></asp:Title></Titles>
<Series>
