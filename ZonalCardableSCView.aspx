<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZonalCardableSCView.aspx.cs" Inherits="Default3" %>
...
<head runat="server">
   <title>Zonal View Cardable Accounts</title>
<meta charset="utf-8"/>
...
<% string connStri = ConfigurationManager.ConnectionStrings["ConnStrSql"].ConnectionString;
    ...
    CMD1i.CommandText = string.Format("SELECT BRANCH_TABLE.ZONE,BRANCH_TABLE.BRANCH,UAP_CARDABLE.SCHM_CODE,COUNT(UAP_CARDABLE.FORACID) AS CARDABLE_COUNT FROM BRANCH_TABLE JOIN UAP_CARDABLE ON BRANCH_TABLE.SOL_ID =UAP_CARDABLE.SOL_ID GROUP BY BRANCH_TABLE.SOL_ID,BRANCH_TABLE.ZONE,BRANCH_TABLE.BRANCH,UAP_CARDABLE.SCHM_CODE ORDER BY COUNT(UAP_CARDABLE.FORACID) DESC");
...
<div class="table-responsive">   
    <table id="example" class="table table-bordered table-hover table-striped" style="font-size:10px">
        <caption style="background-color:gold;"><h6 style="font-family: Corbel; color: #FFFFFF; font-weight: bold">ZONAL VIEW:CARDABLE ACCOUNTS BY SCHEME CODE</h6></caption> 
        <thead>
            <tr>
                <th>ZONE</th>
                <th>BRANCH</th>
        ...
        <tbody>
               <%
                   ...
                   {   a1 = (sqlreaderi.GetValue(sqlreaderi.GetOrdinal("ZONE")).ToString());
                       ...
                       a4 = Convert.ToDouble(sqlreaderi.GetValue(sqlreaderi.GetOrdinal("CARDABLE_COUNT")).ToString());                      
