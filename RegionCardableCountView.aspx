<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegionCardableCountView.aspx.cs" Inherits="Default2" %>
...
<head runat="server">
    <title> Region View: Cardable Count</title>
    <meta charset="utf-8"/>
...
<% string connStri = ConfigurationManager.ConnectionStrings["ConnStrSql"].ConnectionString;
    ...
    CMD1i.CommandText = string.Format("SELECT BRANCH_TABLE.REGION,COUNT(UAP_CARDABLE.FORACID) AS CARDABLE_COUNT FROM BRANCH_TABLE JOIN UAP_CARDABLE ON BRANCH_TABLE.SOL_ID =UAP_CARDABLE.SOL_ID GROUP BY BRANCH_TABLE.REGION ORDER BY  COUNT(UAP_CARDABLE.FORACID) DESC");
...
<div class="table-responsive">   
    <table id="example" class="table table-bordered table-hover table-striped" style="font-size:10px">
        <caption style="background-color:gold;"><h6 style="font-family: Corbel; color: #FFFFFF; font-weight: bold">REGION VIEW: CARDABLE ACCOUNTS</h6></caption> 
        <thead>
            <tr>
                <th>REGION</th>
