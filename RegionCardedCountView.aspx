<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegionCardedCountView.aspx.cs" Inherits="Default5" %>
...
<head runat="server">
   <title>Regional View Carded Accounts</title>
<meta charset="utf-8"/>
...
<% string connStri = ConfigurationManager.ConnectionStrings["ConnStrSql"].ConnectionString;
    ...
    CMD1i.CommandText = string.Format("SELECT BRANCH_TABLE.REGION ,COUNT(UAP_CARDED.ACCOUNT_ID) AS CARDCOUNT FROM BRANCH_TABLE JOIN UAP_CARDED ON BRANCH_TABLE.SOL_ID =UAP_CARDED.BRANCH_CODE GROUP BY BRANCH_TABLE.REGION ORDER BY  COUNT(UAP_CARDED.ACCOUNT_ID) DESC");
...
<div class="table-responsive">   
    <table id="example" class="table table-bordered table-hover table-striped" style="font-size:10px">
        <caption style="background-color:gold;"><h6 style="font-family: Corbel; color: #FFFFFF; font-weight: bold">REGION VIEW: CARDED ACCOUNTS</h6></caption> 
        <thead>
            <tr>
                <th>REGION</th>
