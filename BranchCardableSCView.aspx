<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchCardableSCView.aspx.cs" Inherits="Default4" %>
...
<head runat="server">
<title>Branch View Cardable Accounts</title>
<meta charset="utf-8"/>
...
<% string connStri = ConfigurationManager.ConnectionStrings["ConnStrSql"].ConnectionString;
    ...
    CMD1i.CommandText = string.Format("SELECT BRANCH_TABLE.BRANCH,UAP_CARDABLE.SCHM_CODE,COUNT(UAP_CARDABLE.FORACID) AS CARDABLE_COUNT FROM BRANCH_TABLE JOIN UAP_CARDABLE ON BRANCH_TABLE.SOL_ID =UAP_CARDABLE.SOL_ID GROUP BY BRANCH_TABLE.BRANCH,UAP_CARDABLE.SCHM_CODE ORDER BY  COUNT(UAP_CARDABLE.FORACID) DESC");
...
<div class="table-responsive">   
    <table id="example" class="table table-bordered table-hover table-striped" style="font-size:10px">
        <caption style="background-color:gold;"><h6 style="font-family: Corbel; color: #FFFFFF; font-weight: bold">BRANCH CARDABLE ACCOUNTS BY SCHEME CODE</h6></caption> 
        <thead>
            <tr>
                <th>BRANCH</th>
                <th>SCHEME CODE</th>
